...
function prefer_scripts() {
	...
	//*Font-Awesome-master*/
    wp_enqueue_style( 'font-awesome', get_stylesheet_directory_uri() . '/css/font-awesome.min.css', array(), '4.5.0' );

    wp_enqueue_style( 'grid-css', get_stylesheet_directory_uri() . '/css/grid.min.css', array(), '4.5.0' );
    
    /*Slick CSS*/
    wp_enqueue_style( 'slick', get_stylesheet_directory_uri() . '/assets/css/slick.css', array(), '4.5.0' );
	
    /*mmenu CSS*/
    wp_enqueue_style( 'offcanvas-style', get_stylesheet_directory_uri() . '/assets/css/canvi.css', array(), '4.5.0' );

	$masonry =  esc_attr($prefer_theme_options['prefer-column-blog-page']);
    if( 'masonry-post' == $masonry )  {
    	wp_enqueue_script( 'masonry' );
    	wp_enqueue_script( 'prefer-custom-masonry', get_stylesheet_directory_uri() . '/assets/js/custom-masonry.js', array('jquery'), '4.6.0' );
   }
 ...
 $prefer_pagination_option =  esc_attr($prefer_theme_options['prefer-pagination-options']);
    ...
    if( 'ajax' == $prefer_pagination_option )  {
    	...
    	wp_enqueue_script( 'prefer-custom-pagination', get_stylesheet_directory_uri() . '/assets/js/custom-infinte-pagination.js', array('jquery'), '4.6.0' );
    }

	wp_enqueue_script( 'prefer-navigation', get_stylesheet_directory_uri() . '/js/navigation.js', array(), '20200412', true );

	/*Slick JS*/
    wp_enqueue_script( 'slick', get_stylesheet_directory_uri() . '/assets/js/slick.js', array('jquery'), '4.6.0' );
    
    /*mmenu JS*/
    $canvi =  absint($prefer_theme_options['prefer_enable_offcanvas']);
    if( 1  == $canvi )  {
        wp_enqueue_script( 'offcanvas-script', get_stylesheet_directory_uri() . '/assets/js/canvi.js', array('jquery'), '4.6.0' );
        wp_enqueue_script( 'offcanvas-custom', get_stylesheet_directory_uri() . '/assets/js/canvi-custom.js', array('jquery'), '4.6.0' );
    }
    
    /*Custom Script JS*/
	wp_enqueue_script( 'prefer-script', get_stylesheet_directory_uri() . '/assets/js/script.js', array(), '20200412', true );
    
	/*Custom Scripts*/
	wp_enqueue_script( 'prefer-custom', get_stylesheet_directory_uri() . '/assets/js/custom.js', array(), '20200412', true );
	...
	wp_enqueue_script( 'prefer-skip-link-focus-fix', get_stylesheet_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20200412', true );

	/*Sticky Sidebar*/
	global $prefer_theme_options;
	if( 1 == absint($prefer_theme_options['prefer-enable-sticky-sidebar'])) {
		wp_enqueue_script( 'theia-sticky-sidebar', get_stylesheet_directory_uri() . '/assets/js/theia-sticky-sidebar.js', array(), '20200412', true );
        wp_enqueue_script( 'prefer-sticky-sidebar', get_stylesheet_directory_uri() . '/assets/js/custom-sticky-sidebar.js', array(), '20200412', true );
	}
