...
if( !function_exists( 'prefer_blog_sidebar_position_array' ) ) :
    ...
    function prefer_blog_sidebar_position_array() {
        ...
        $sidebar_positions = array(
            'right-sidebar'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/right-sidebar.png'),
            'left-sidebar' => esc_url(get_stylesheet_directory_uri() . '/assets/images/left-sidebar.png'),
            'no-sidebar'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/no-sidebar.png'),
            'middle-column'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/middle-content.png'),
        );
...
if( !function_exists( 'prefer_sidebar_position_array' ) ) :
    ...
    function prefer_sidebar_position_array() {
        ...
        $sidebar_positions = array(
            'single-right-sidebar'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/right-sidebar.png'),
            'single-left-sidebar' => esc_url(get_stylesheet_directory_uri() . '/assets/images/left-sidebar.png'),
            'single-no-sidebar'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/no-sidebar.png'),
            'single-middle-column'  => esc_url(get_stylesheet_directory_uri() . '/assets/images/middle-content.png'),
        );
